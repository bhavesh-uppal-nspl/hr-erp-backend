...
class payrollLoanController extends Controller
{
    public function index(Request $request, $org_id)
    {
        try {
            ...
            $query = PayrollLoan::with('LoanType', 'Employee')->where('organization_id', $org_id);
            ...
            return response()->json([
                'message' => 'Payroll Loan  fetched successfully',
                'payroll' => $statusTypes
            ], 200);
    ...
    public function store(Request $request, $org_id)
    {
        try {
            ...
            $validator = Validator::make($request->all(), [
                ...
                'organization_payroll_loan_type_id' => 'nullable|integer|exists:organization_payroll_loan_types,organization_payroll_loan_type_id',
                'status' => 'nullable|in:Requested,Approved,Rejected,Disbursed,InRepayment',
                'loan_amount' => 'nullable|numeric',
                'balance_amount' => 'nullable|numeric',
                'interest_rate' => 'nullable|numeric',
                'emi_amount' => 'nullable|numeric',
                'total_installments' => 'nullable|integer',
                'installments_remaining' => 'nullable|integer',
    ...
    public function show(Request $request, $org_id, $loan_id)
    {
        try {
            ...
            $request->merge([
                ...
                'organization_payroll_loan_id' => $loan_id
            ]);
            $validator = Validator::make($request->all(), [
                'organization_id' => 'required|integer|exists:organizations,organization_id',
                'organization_payroll_loan_id' => 'required|integer|exists:organization_payroll_loans,organization_payroll_loan_id',
            ...
            $payroll = PayrollLoan::find($loan_id);
            $payroll->load('LoanType', 'Employee');
            return response()->json([
                'message' => 'Payroll loan found',
                'payroll' => $payroll
            ], 200);
    ...
    public function update(Request $request, $org_id, $loan_id)
    {
        try {
            ...
            return response()->json([
                'message' => 'Payroll loan  Updated Successfully.',
                'payroll' => $payroll
            ], 201);
    ...
    public function destroy(Request $request, $org_id, $load_id)
    {
        try {
            $request->merge([
                'organization_id' => $org_id,
                'organization_payroll_loan_id' => $load_id
            ]);
            $validator = Validator::make($request->all(), [
                   'organization_entity_id' => 'nullable|integer|exists:organization_entities,organization_entity_id',
                'organization_payroll_loan_type_id' => 'nullable|integer|exists:organization_payroll_loan_types,organization_payroll_loan_type_id',
            ...
            $payroll = PayrollLoan::find($load_id);
            $payroll->delete();
            return response()->json([
                'message' => 'payroll loan Deleted Successfully'
            ], 200);
