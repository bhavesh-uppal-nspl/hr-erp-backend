...
class PayrollAdjustmentTypeController extends Controller
{
    public function index(Request $request, $org_id)
    {
        try {
            ...
            $query = PayrollAdjustmentType::where('organization_id', $org_id);
            if (!empty($search)) {
            ...
            return response()->json([
                'message' => 'Payroll Adjustment Type  fetched successfully',
                'payroll' => $statusTypes
            ], 200);
        ...
        try {
            ...
            $validator = Validator::make($request->all(), [
                ...
                'adjustment_type_name' => [
                    ...
                    'string',
                    'max:255',
                    Rule::unique('organization_payroll_adjustment_types', 'adjustment_type_name')
                        ->where(function ($query) use ($request) {
                            return $query->where('organization_id', $request->organization_id);
                        }),
                ],
                'adjustment_direction' => 'nullable|in:Earning,Deduction',
            ...
            $data = $request->all();
            PayrollAdjustmentType::create($data);

            return response()->json([
                'message' => 'Payroll Adjsutment Type added successfully.',
            ], 201);
    ...
    public function show(Request $request, $org_id, $type_id)
    {
        try {
            ...
            $payroll = PayrollAdjustmentType::find($type_id);
            return response()->json([
    ...
    public function update(Request $request, $org_id, $type_id)
    {
        try {
            ...
            $rules = [
                ...
                'adjustment_type_name' => [
                    ...
                    Rule::unique('organization_payroll_adjustment_types', '	adjustment_type_name')
                        ...
                        ->ignore($type_id, 'organization_payroll_adjustment_type_id'),
                ],
            ...
            return response()->json([
                'message' => 'Payroll Adjustment type Updated Successfully.',
            ], 201);
    ...
    public function destroy(Request $request, $org_id, $type_id)
    {
        try {
            ...
            $payroll->delete();
            return response()->json([
                'message' => 'payroll adjustment type  Deleted Successfully'
            ], 200);
