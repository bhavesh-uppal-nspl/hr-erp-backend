...
class OrganizationEmploymentStatusController extends Controller
{
    ...
    public function index(Request $request, $org_id)
    {
        try {
            ...
            $query = OrganizationEmployementStatus::with('organization')->where('organization_id', $org_id);
        ...
        try {
            ...
            $validator = Validator::make($request->all(), [
                ...
                'employment_status_name' => [
                    ...
                    'string',
                    'max:255',
                    Rule::unique('organization_employment_statuses', 'employment_status_name')
            ...
            $data = $request->all();
            $status = OrganizationEmployementStatus::create($data);
            return response()->json([
                'message' => 'Organization Employment status  Added SuccessFully.',
                'status' => $status
            ], 201);
        } catch (\Exception $e) {
    ...
    public function show(Request $request, $org_id, $status_id)
    {
        try {
            ...
            $status = OrganizationEmployementStatus::find($status_id);
    ...
    public function update(Request $request, $org_id, $status_id)
    {
        try {
            ...
            $request->merge([
                ...
                'organization_employment_status_id' => $status_id
            ]);
            $rules = [
                'organization_id' => 'required|integer|exists:organizations,organization_id',
                'organization_employment_status_id' => 'required|integer|exists:organization_employment_statuses,organization_employment_status_id',
            ...
            return response()->json([
                'message' => 'Organization employment status updated successfully.',
                'status' => $status
            ], 201);
    ...
    public function destroy(Request $request, $org_id, $status_id)
    {
        try {
            ...
            $status->delete();
            return response()->json([
                'message' => 'Organization Employment Status Deleted Successfully'
