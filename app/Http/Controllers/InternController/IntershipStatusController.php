...
class IntershipStatusController extends Controller
{
        ...
        try {
            ...
            if ($validator->fails()) {
             ...
             if ($request->input('mode') == 1) {
                $status = IntershipStatus::where('organization_id', $org_id)->get();
                ...
                $mappedStatus = $status->map(function ($dep) {
                    return [
                        'internship_status_name'=>$dep->internship_status_name, 
                    ];
                });
            ...
            $query = IntershipStatus::where('organization_id', $org_id);
        ...
        try {
            ...
            $validator = Validator::make($request->all(), [
                ...
                'internship_status_name' => [
                    ...
                    'string',
                    'max:255',
                    Rule::unique('organization_internship_statuses', 'internship_status_name')
            ...
            $data = $request->all();
            $intership = IntershipStatus::create($data);
            return response()->json([
                'message' => 'Organization Intership Status Added Successfully.',
                'intership' => $intership
            ], 201);
    ...
    public function show(Request $request, $org_id, $intern_id)
    {
        try {
            ...
            $intership = IntershipStatus::find($intern_id);
            return response()->json([
    ...
    public function update(Request $request, $org_id, $intern_id)
    {
        try {
            ...
            $request->merge([
                ...
                'organization_internship_status_id' => $intern_id
            ]);
            $rules = [
                'organization_id' => 'required|integer|exists:organizations,organization_id',
                'organization_internship_status_id' => 'required|integer|exists:organization_internship_statuses,organization_internship_status_id',
                'internship_status_name' => [
                    ...
                    'max:255',
                    Rule::unique('organization_internship_statuses', 'internship_status_name')
                        ->ignore($intern_id, 'organization_internship_status_id')
    ...
    public function destroy(Request $request, $org_id, $intern_id)
    {
        try {
            ...
            $intership->delete();
            return response()->json([
                'message' => 'Organization Intership Status Deleted SuccessFully !'
