...
class InternAttendanceRecordController extends Controller
{
        ...
        public function index(Request $request, $org_id)
    {
        try {
            ...
            // Start query
            $query = InternAttendanceRecord::with('statusType', 'Intern');
            ...
            return response()->json([
                'message' => 'Intern Attendance Record  fetched successfully',
